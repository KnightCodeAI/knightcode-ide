        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "File Bug Report...",
                    super::OpenBrowser {
                        url: "https://github.com/KnightCodeAI/knightcode-ide/issues".into(),
                    },
                ),
                MenuItem::separator(),
                MenuItem::action(
                ...
                MenuItem::action(
                    "KnightCode Repository",
                    super::OpenBrowser {
                        url: "https://github.com/KnightCodeAI/knightcode-ide".into(),
                    },
                ),
            ],
        },
