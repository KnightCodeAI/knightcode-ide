...
AppPublisher=KnightCodeAI
AppPublisherURL=https://knightcode.dev/
AppSupportURL=https://github.com/KnightCodeAI/knightcode-ide/issues
AppUpdatesURL=https://knightcode.dev/
...
[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl,{#ResourcesDir}\messages\en.isl"; LicenseFile: "{#ResourcesDir}\license.txt"
Name: "simplifiedChinese"; MessagesFile: "{#ResourcesDir}\messages\Default.zh-cn.isl,{#ResourcesDir}\messages\zh-cn.isl"; LicenseFile: "{#ResourcesDir}\license.txt"
...
; The classic shell verbs, on every Windows version: the Windows 11 appx that
; replaces them upstream is not shipped. Windows 11 lists them under "Show more
; options".
...
Root: HKCU; Subkey: "Software\Classes\directory\shell\{#RegValueName}"; ValueType: expandsz; ValueName: ""; ValueData: "{cm:OpenWithContextMenu,{#ShellNameShort}}"; Tasks: addcontextmenufolders; Flags: uninsdeletekey
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\knightcode"; ValueType: "string"; ValueData: "URL:knightcode Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\knightcode"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\knightcode\DefaultIcon"; ValueType: "string"; ValueData: "{app}\{#AppExeName}.exe,1"
Root: HKCU; Subkey: "Software\Classes\knightcode\shell\open\command"; ValueType: "string"; ValueData: """{app}\{#AppExeName}.exe"" ""%1"""
