...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "KnightCode"),
        "preview" => ("app-icon-preview.ico", "KnightCode Preview"),
        "nightly" => ("app-icon-nightly.ico", "KnightCode Nightly"),
        _ => ("app-icon-dev.ico", "KnightCode Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "KnightCodeAI\0"
            VALUE "LegalCopyright", "Copyright 2026 KnightCodeAI. Portions copyright 2022 - 2025 Zed Industries, Inc.\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
